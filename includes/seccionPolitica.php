...
<head>
  ...
  <title>Politica: Mexicanadas</title>
...
<body style="background: url(resources/assets/collage.png);">
  <br><br><br><br>
<!-- ---------------------------------------------------
                    CONTENIDO
----------------------------------------------------- -->
<div class="container-xl">
    <div class="row">
        <div class="p-2 p-md-3 mb-2 text-white rounded bg-">
            ...
            <p class="textcoloraized text-shadow">P O L I T I C A</p>
        </div>
    </div>
  </div>
  ...
  <div class="container-sm">
    <div class="row justify-content-md-center">
      ...
      <div class="col-auto col-md-4"> <!-- Primera columna-->
        ...
        <nav class="colore-carta3 navbar navbar-light bg-light shadow-sm p-3 mb-5 bg-body rounded border border-secondary"> <!-- Aqui se pone el buscador -->
            <div class="colore-carta-search container-fluid">
              <form class="d-flex">
          ...
          <?php for ($i=0;$i < 6; $i++): ?>
			<div class="colore-carta3 card shadow-sm bg-body rounded border border-secondary">
